...
export function SwapBottomCard() {
  ...
  const isBridgingSupportedChain = useIsBridgingChain(chainId ?? UniverseChainId.Zanjir)
...
const CHAIN_THEME_LIGHT: Record<UniverseChainId, ChainTheme> = {
  [UniverseChainId.Zanjir]: { bgColor: '#6B8AFF33', textColor: '#6B8AFF' },
  [UniverseChainId.ZanjirTestnet]: { bgColor: '#00A3FF33', textColor: '#00A3FF' },
}
