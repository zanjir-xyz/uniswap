...
export const STABLECOIN_AMOUNT_OUT: Record<UniverseChainId, CurrencyAmount<Token>> = {
  [UniverseChainId.Zanjir]: CurrencyAmount.fromRawAmount(USDC_ZANJIR, USDC_DEFAULT_MIN),
  [UniverseChainId.ZanjirTestnet]: CurrencyAmount.fromRawAmount(USDC_ZANJIR, USDC_DEFAULT_MIN),
}
