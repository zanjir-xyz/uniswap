...
export function isMainnetChainId(chainId?: UniverseChainId): boolean {
  return chainId === UniverseChainId.Zanjir || chainId === UniverseChainId.ZanjirTestnet
}
...
export function fromUniswapWebAppLink(network: string | null): UniverseChainId | null {
  switch (network) {
    case Chain.Ethereum.toLowerCase():
      return UniverseChainId.Zanjir
    case Chain.Zanjir.toLowerCase():
      return UniverseChainId.Zanjir
    case Chain.ZanjirTestnet.toLowerCase():
      return UniverseChainId.ZanjirTestnet
    default:
...
export function toUniswapWebAppLink(chainId: UniverseChainId): string | null {
  switch (chainId) {
    case UniverseChainId.Zanjir:
      return Chain.Zanjir.toLowerCase()
    case UniverseChainId.ZanjirTestnet:
      return Chain.ZanjirTestnet.toLowerCase()
    default:
...
export function getEnabledChains({
  ...
  if (isTestnetModeEnabled) {
    ...
    return {
      ...
      defaultChainId: UniverseChainId.ZanjirTestnet as UniverseChainId,
      isTestnetModeEnabled,
    }
  }
  ...
  return {
    ...
    defaultChainId: UniverseChainId.Zanjir as UniverseChainId,
    isTestnetModeEnabled,
  }
}
