...
export enum UniverseChainId {
  Zanjir = UniswapSDKChainId.ZANJIR,
  ZanjirTestnet = UniswapSDKChainId.ZANJIR_TESTNET,
}
...
export type GqlChainId = Exclude<BackendChainId, BackendChainId.UnknownChain>
